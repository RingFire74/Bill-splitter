...
public class ContactAdapter extends BaseAdapter implements ListAdapter {
    ...
    public ContactAdapter(ArrayList<String> nameList, ArrayList<String> list2, Context context, Activity activity) {
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        button.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (button.isChecked()) {
                    conn.onCheckedBox(nameList.get(position), position, "true",attendenceList.get(position));
                } else {
                    conn.onCheckedBox(nameList.get(position), position, "false",attendenceList.get(position));
                }
            }
        });
