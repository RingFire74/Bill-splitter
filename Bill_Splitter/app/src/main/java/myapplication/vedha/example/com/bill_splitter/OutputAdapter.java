...
public class OutputAdapter extends BaseAdapter implements ListAdapter {
    ...
    public OutputAdapter(ArrayList<String> nameList, ArrayList<String> list2, Context context, Activity activity) {
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        if (view == null) {
            ...
            view = inflater.inflate(R.layout.list_output, null);
        }
